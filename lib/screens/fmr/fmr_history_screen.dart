...
class FmrHistoryScreen extends StatefulWidget {
  @override
  _FmrHistoryScreenState createState() => _FmrHistoryScreenState();
}

class _FmrHistoryScreenState extends State<FmrHistoryScreen> {
  var modules, doc;
  ...
  Future<Null> getDocList() async {
    ...
    final response =
        await http.get(server + '/fmr/getDocList.php?user='+userID+'&page=h');
